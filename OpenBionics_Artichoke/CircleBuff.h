...
// uncomment the following to enable standard deviation mode
//#define USE_STD_DEV
...
#endif
#ifdef USE_STD_DEV
		uint32_t readStardardDev(void);			// read the standard deviation of the buffer
#endif
...
#ifdef USE_STD_DEV
		standardDev_t standardDev;			// running standard deviation result, mean and total
#endif
